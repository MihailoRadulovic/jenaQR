function Button({ children, active, setActive }) {
  return (
    <button
      ...
      className={` rounded-full mt-8 mr-1 px-4 py-2 flex items-center justify-center text-[var(--asparagus-100)] text-2xl 
        ...
        ${active ? "bg-[var(--asparagus-700)]" : "bg-[var(--asparagus-950)]"}`}
      onClick={setActive}
    >
      {children}
    </button>
