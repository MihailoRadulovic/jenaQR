...
const drinks = [
  {
    ...
    items: [
      ...
      { name: "Domaća kafa", price: "130 RSD" },
      ...
      { name: "Topla čokolada", price: "230 RSD" },
      { name: "Čaj Dolcezza", price: "200 RSD" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cedevita pomorandža", capacity: "0.3l", price: "190 RSD" },
      { name: "Cedevita limun", capacity: "0.3l", price: "190 RSD" },
      { name: "Cedevita limun / zova", capacity: "0.3l", price: "190 RSD" },
      { name: "Cedevita limeta", capacity: "0.3l", price: "190 RSD" },
      { name: "Fuze tea", capacity: "0.33l", price: "210 RSD" },
    ],
    photo: stillDrink,
  },
  {
  ...
  },
  {
    ...
    icon: "SlEnergy ",
    items: [
      { name: "Guarana", capacity: "0.25l", price: "210 RSD" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Međaš crno", capacity: "0.187l", price: "300 RSD" },
